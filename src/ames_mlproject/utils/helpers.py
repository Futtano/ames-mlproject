...
categorical_invariants: dict[str, list[Any]] = {
    ...
    "OverallQual": list(range(10, 0, -1)),
    "OverallCond": list(range(10, 0, -1)),
...
bldgtype_correct_values = {"Twnhs": "TwnhsI", "Duplex": "Duplx", "2fmCon": "2FmCon"}

exterior1st_correct_values = {"Wd Sdng": "WdSdng", "Wd Shing": "WdShng", "WdShing": "WdShng"}
